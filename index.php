                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-danger">
                        <!-- Muestra la imagen del producto. Si 'imagen' está vacío, usa 'default-pizza.jpg' -->
                         <center>
                             <img src="assets/img/<?php echo htmlspecialchars($producto['imagen'] ?: 'default-pizza.jpg'); ?>" class="card-img-top img-fluid" style="height: 200px; width: fit-content; object-fit: containt;" alt="<?php echo htmlspecialchars($producto['nombre']); ?>">
                         </center>
